...
@section('content')
    <x-container>
        <div class="col-12">
                    ...
                    <tbody>
                        @foreach ($products as $i => $product )
                            <tr>
                                ...
                                <td>
                                    <span class="avatar rounded avatar-md" style="background-image: url({{ $product->image }})"></span>
                                </td>
                                <td>{{ $product->name }}</td>
                                ...
                                <td>
                                    @can('product-update')
                                        <a href="{{ route('backoffice.product.edit', $product->id) }}" class="btn btn-info btn-sm">
            ...
            <div class="d-flex justify-content-end">{{ $products->links('pagination::bootstrap-5') }}</div>
        </div>
    </x-container>
