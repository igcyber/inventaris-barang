@extends('layouts.backoffice.master', ['title' => 'Perizinan'])

@section('content')
    <x-container>
        <div class="col-12 col-lg-8">
            <x-card-action title="Daftar Perizinan" url="{{ route('backoffice.permission.index') }}">
                <x-table>
                    <thead>
                        <tr>
                            <th>#</th>
            ...
            <div class="d-flex justify-content-end">{{ $permissions->links('pagination::bootstrap-5') }}</div>
        </div>
