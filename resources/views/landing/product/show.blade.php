@extends('layouts.landing.master', ['title' => 'Detil Produk'])
...
@section('content')
    ...
    <x-landing.container>
        <div class="lg:w-4/5 mx-auto flex flex-wrap justify-center bg-white p-6 rounded-lg border">
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:p-6 mt-6 lg:mt-0">
                ...
                <div class="flex mt-6 items-center pb-5 border-b-2 mb-5 justify-between">
                    ...
                    <h1 class="{{ $product->quantity > 0 ? 'text-green-700' : 'text-red-700' }} text-xl font-bold">
                        {{ $product->quantity }}
                    </h1>
                </div>
